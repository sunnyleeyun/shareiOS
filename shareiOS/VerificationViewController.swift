...
class VerificationViewController: UIViewController {
    ...
    @IBAction func identityFront(_ sender: Any) {
    ...
    @IBAction func identityBack(_ sender: Any) {
        // 建立一個 UIImagePickerController 的實體
        let imagePickerController = UIImagePickerController()
    ...
    @IBAction func driverFront(_ sender: Any) {
    ...
    @IBAction func driverBack(_ sender: Any) {
                ...
                if let uploadData = UIImagePNGRepresentation(selectedImage) {
                    ...
                    storageRef.put(uploadData, metadata: nil, completion: { (data, error) in
                        ...
                        if let uploadImageUrl = data?.downloadURL()?.absoluteString {
                            ...
                            let databaseRef = FIRDatabase.database().reference(withPath: "User/\(self.uid)/Profile/Photo")
